...
#
# Writes: dist/cmrr-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix cmrr \
  --exe-name ColinMcRaeRally_Recompiled \
  --display-name "ColinMcRaeRally Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned ColinMcRaeRally disc" \
